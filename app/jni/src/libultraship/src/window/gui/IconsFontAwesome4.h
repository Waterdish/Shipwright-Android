// Generated by https://github.com/juliettef/IconFontCppHeaders script GenerateIconFontCppHeaders.py for languages C and
// C++ from https://github.com/FortAwesome/Font-Awesome/raw/4.x/src/icons.yml for use with
