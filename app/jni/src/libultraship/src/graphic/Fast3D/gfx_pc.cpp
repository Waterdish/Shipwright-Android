...
void gfx_run(Gfx* commands, const std::unordered_map<Mtx*, MtxF>& mtx_replacements) {
    ...
    //SDL_Log("updating framebuffer parameters");
    ...
    //SDL_Log("updated framebuffer parameters");
    gfx_rapi->start_frame();
    //SDL_Log("started frame");
    gfx_rapi->start_draw_to_framebuffer(game_renders_to_framebuffer ? game_framebuffer : 0,
                                        (float)gfx_current_dimensions.height / SCREEN_HEIGHT);
    //SDL_Log("started draw to framebuffer");
    gfx_rapi->clear_framebuffer();
    rdp.viewport_or_scissor_changed = true;
    ...
    //SDL_Log("Drawing to framebuffer");
