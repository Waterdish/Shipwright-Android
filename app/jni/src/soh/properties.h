...
#define VER_FILEVERSION_STR      "8.0.6\0"

#define VER_PRODUCTVERSION       8, 0, 6, 0
#define VER_PRODUCTVERSION_str   "8.0.6\0"
...
#define VER_FILEDESCRIPTION_STR  "Ship of Harkinian - MacReady Golf\0"
